...
public enum RDDSKitAsset {
  ...
  public enum Images {
    ...
    public static let feelingXsStange = RDDSKitImages(name: "feeling_xs_stange")
    public static let homeHackground = RDDSKitImages(name: "home_background")
