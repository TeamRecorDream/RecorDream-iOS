...
public enum RDDSKitAsset {
  ...
  public enum Images {
    ...
    public static let feelingXsBright = RDDSKitImages(name: "feeling_xs_bright")
    public static let feelingXsFright = RDDSKitImages(name: "feeling_xs_fright")
    ...
    public static let feelingXsWeird = RDDSKitImages(name: "feeling_xs_weird")
    ...
    public static let icnRdVoiceS = RDDSKitImages(name: "icn_rd_voice_s")
