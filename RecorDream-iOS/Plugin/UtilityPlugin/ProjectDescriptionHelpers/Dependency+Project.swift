...
public extension TargetDependency.Project {
    ...
    static let Presentation = TargetDependency.project(target: "Presentation", path: .relativeToRoot("Projects/Presentation/Presentation"))
    
    static let RDCore = TargetDependency.project(target: "RD-Core", path: .relativeToRoot("Projects/Core/RD-Core"))
    
    static let Data = TargetDependency.project(target: "Data", path: .relativeToRoot("Projects/Data/Data"))
    
    static let Domain = TargetDependency.project(target: "Domain", path: .relativeToRoot("Projects/Domain/Domain"))
